 ...
 * Generator for pages
 */
class PageGenerator extends BaseGenerator_1.BaseGenerator {
    initializing() {
    ...
    _getDirectories(srcpath) {
        ...
        try {
            ...
            this.env.error("[Error] Error reading directories: " + e.message);
        }
        return dirs;
    }
    /**
 ...
 * @type {string}
 */
PageGenerator.ERROR_PAGE_EXISTS = "The page indicated already exists. Please, choose another name";
/**
 * Error for non existing course
 * @type {string}
 */
PageGenerator.ERROR_COURSE_DOESNT_EXISTS = "Before creating a page is necessary create a course and sco. Please use 'yo haztivity'";
/**
 * Error for non existing sco
 * @type {string}
 */
PageGenerator.ERROR_SCO_DOESNT_EXISTS = "Before creating a page is necessary create a sco. Please use 'yo haztivity:sco'";
